jQuery(document).ready(function () {
  jQuery(".github-color:contains('PHP')").addClass("PHP");
  jQuery(".github-color:contains('Go')").addClass("Go");
  jQuery(".github-color:contains('Shell')").addClass("Shell");
  jQuery(".github-color:contains('Ruby')").addClass("Ruby");
  jQuery(".github-color:contains('Python')").addClass('Python');
